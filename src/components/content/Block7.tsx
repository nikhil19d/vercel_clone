const Block7 = () =>{
  ...
  <rect width="16" height="16" fill="red"></rect>
        ...
        <div className="mt-8 w-11/12 h-1/4 flex flex-col border z-10">
          ...
          <div className="relative bottom-logoPos h-templatedim flex justify-center">
            <svg className="relative top-5 border border-react rounded-full border-dashed m-2 p-3.5" data-testid="geist-icon" height="65" stroke-linejoin="round" viewBox="0 0 16 16" width="65"><g clip-path="url(#clip0_872_3183)">
        ...
        <div className="mt-8 w-11/12 h-1/4 flex flex-col justify-end border">
          ...
          <div className="h-96 w-height-div flex flex-col justify-evenly rotate-90 relative bottom-reB left-reL z-20">
            ...
            <hr className="border-dashed border-svelte"></hr>
             ...
             <div className="relative h-templatedim bottom-logoPos flex justify-center">
            <svg className='relative top-5 border border-dashed border-svelte rounded-full p-3.5 m-2' data-testid="geist-icon" height="65" stroke-linejoin="round" viewBox="0 0 16 16" width="65"><g clip-path="url(#clip0_872_3178)">
