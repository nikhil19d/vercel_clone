const Block8 = () =>{
  return(
  <div className="h-block8 flex">
  <div className="w-2/3 border flex justify-center items-center h-block8">
  ...
  <div className="w-1/3 h-block8 flex justify-center items-center border">
